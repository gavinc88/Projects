"""Gavin Chu (cs61a-ux) & Eric O'neill (cs61a-ve)"""
...
##            print('{0} ran out of armor and expired'.format(self))
##            while num_bees >= 0:
##                self.place.bees[num_bees].reduce_armor(self.fire_damage)
##                num_bees -= 1
##            self.place.remove_insect(self)
...
## Does not stack effects
##    def effect_self(self):
##        counter = 0
##
##        def original_action (colony):
##            if self.blocked():
##                return self.sting(self.place.ant)
##            else:
##                if self.place.name != 'Hive' and self.armor > 0:
##                    return self.move_to(self.place.exit)
##            
