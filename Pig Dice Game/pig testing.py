...
def hold(turn_total, outcome):
    ...
    turn_score = 0
    turn_over = True
    return score, turn_score, turn_over
...
def draw_number(n, dot='*'):
    ...
    """
    if n == 1:
        print(draw_die(True, False, False, False, dot))
    elif n == 2:
        print(draw_die(False, True, False, False, dot))
    elif n == 3:
        print(draw_die(True, True, False, False, dot))
    elif n == 4:
        print(draw_die(False, True, True, False, dot))
    elif n == 5:
        print(draw_die(True, True, True, False, dot))
    else:
        print(draw_die(False, True, True, True, dot))
    return ''
...
def make_pride_strategy(margin, turn_goal=20):
    ...
    def strategy(score1, score2):
        def plan(turn):
            if score1+turn-score2 > margin and turn >= turn_goal:
                return hold
            else:
                return roll
        return plan
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    """elif 100-score <= 23:
        def plan(turn):
            new_goal = 23
            score_until_win = 100-socre
            while score_until_win < new_goal:
                new_goal = score_until_win
            if turn> new_goal:
                return hold
            else:
                return roll
        return plan
    elif score1+turn-score2 > margin:
        def plan(turn):
            if score1+turn-score2 > margin and turn >= turn_goal:
                return hold
            else:
    ...
    elif (score+turn+opponent_score)%7 == 0:
        return hold"""
    elif score>90:
